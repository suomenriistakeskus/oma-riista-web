...
angular.module('app.harvestpermit.application.dogdisturbance.applicant', ['app.metadata'])
    .config(function ($stateProvider) {
        $stateProvider
            .state('profile.permitwizard.dogdisturbance.applicant', {
                url: '/applicant',
            ...
            .state('jht.decision.application.wizard.dogdisturbance.applicant', {
                url: '/applicant',
                templateUrl: 'harvestpermit/applications/dogdisturbance/applicant/applicant.html',
                controller: 'DogDisturbanceApplicantController',
                controllerAs: '$ctrl',
    ...
    .controller('DogDisturbanceApplicantController', function ($state, wizard, application,
                                                               DogDisturbanceApplication,
        ...
        $ctrl.save = function () {
            ...
            return DogDisturbanceApplication.updatePermitHolder({id: application.id}, $ctrl.permitHolder).$promise;
        };
    });
