...
angular.module('app.harvestpermit.application.dogdisturbance.summary', ['app.metadata'])
    .config(function ($stateProvider) {
        $stateProvider
            .state('profile.permitwizard.dogdisturbance.summary', {
                url: '/summary',
            ...
            .state('jht.decision.application.wizard.dogdisturbance.summary', {
                url: '/summary',
                templateUrl: 'harvestpermit/applications/dogdisturbance/summary/summary.html',
                controller: 'DogDisturbanceSummaryController',
                controllerAs: '$ctrl',
    ...
    .controller('DogDisturbanceSummaryController', function ($scope, $q, $translate, $filter, dialogs,
    ...
    .component('rDogDisturbanceApplicationSummary', {
        templateUrl: 'harvestpermit/applications/dogdisturbance/summary/summary-accordion.html',
        bindings: {
            application: '<'
        },
        controller: function () {
            ...
            $ctrl.getEventCount = function () {
                return _.size($ctrl.application.events);
            };
        }
    })
    .component('rDogDisturbanceApplicationSummaryDetails', {
        templateUrl: 'harvestpermit/applications/dogdisturbance/summary/summary-details.html',
        bindings: {
            event: '<'
        }
    })

    .component('rDogDisturbanceApplicationSummaryArea', {
        templateUrl: 'harvestpermit/applications/dogdisturbance/summary/summary-area.html',
        bindings: {
            application: '<',
            attachments: '<',
            baseUri: '<'
