...
angular.module('app.harvestpermit.application.dogunleash.summary', ['app.metadata'])
    .config(function ($stateProvider) {
        $stateProvider
            .state('profile.permitwizard.dogunleash.summary', {
                url: '/summary',
            ...
            .state('jht.decision.application.wizard.dogunleash.summary', {
                url: '/summary',
                templateUrl: 'harvestpermit/applications/dogunleash/summary/summary.html',
                controller: 'DogUnleashSummaryController',
                controllerAs: '$ctrl',
    ...
    .controller('DogUnleashSummaryController', function ($scope, $q, $translate, $filter, dialogs,
    ...
    .component('rDogUnleashApplicationSummary', {
        templateUrl: 'harvestpermit/applications/dogunleash/summary/summary-accordion.html',
        bindings: {
            application: '<'
        },
        controller: function () {
    ...
    .component('rDogUnleashApplicationSummaryArea', {
        templateUrl: 'harvestpermit/applications/dogunleash/summary/summary-area.html',
        bindings: {
            application: '<',
            attachments: '<',
            baseUri: '<'
    ...
    .component('rDogUnleashApplicationSummaryDetails', {
        templateUrl: 'harvestpermit/applications/dogunleash/summary/summary-details.html',
        bindings: {
            event: '<'
        }
    });
