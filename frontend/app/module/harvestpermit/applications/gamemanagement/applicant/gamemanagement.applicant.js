...
angular.module('app.harvestpermit.application.gamemanagement.applicant', ['app.metadata'])
    .config(function ($stateProvider) {
        $stateProvider
            .state('profile.permitwizard.gamemanagement.applicant', {
                url: '/applicant',
            ...
            .state('jht.decision.application.wizard.gamemanagement.applicant', {
                url: '/applicant',
                templateUrl: 'harvestpermit/applications/gamemanagement/applicant/applicant.html',
                controller: 'GameManagementWizardApplicantController',
                controllerAs: '$ctrl',
    ...
    .controller('GameManagementWizardApplicantController', function ($state, wizard, application,
        ...
        $ctrl.save = function () {
            ...
            return GameManagementPermitApplication.updatePermitHolder({id: application.id}, $ctrl.permitHolder).$promise;
        };
    });
