...
angular.module('app.harvestpermit.application.gamemanagement.summary', ['app.metadata'])
    .config(function ($stateProvider) {
        $stateProvider
            .state('profile.permitwizard.gamemanagement.summary', {
                url: '/summary',
            ...
            .state('jht.decision.application.wizard.gamemanagement.summary', {
                url: '/summary',
                templateUrl: 'harvestpermit/applications/gamemanagement/summary/summary.html',
                controller: 'GameManagementPermitWizardSummaryController',
                controllerAs: '$ctrl',
    ...
    .controller('GameManagementPermitWizardSummaryController', function ($scope, $q, $translate, $filter, dialogs,
    ...
    .component('gameManagementApplicationSummary', {
        templateUrl: 'harvestpermit/applications/gamemanagement/summary/summary-accordion.html',
        bindings: {
            application: '<'
        },
        controller: function () {
    ...
    .component('gameManagementApplicationSummarySpecies', {
        templateUrl: 'harvestpermit/applications/gamemanagement/summary/summary-species.html',
        bindings: {
            species: '<'
        }
    })

    .component('gameManagementApplicationSummaryArea', {
        templateUrl: 'harvestpermit/applications/gamemanagement/summary/summary-area.html',
        bindings: {
            application: '<',
            attachments: '<',
            baseUri: '<'
    ...
    .component('gameManagementApplicationSummaryPeriods', {
        templateUrl: 'harvestpermit/applications/gamemanagement/summary/summary-periods.html',
        bindings: {
            periods: '<'
        }
    })

    .component('gameManagementApplicationSummaryJustification', {
        templateUrl: 'harvestpermit/applications/gamemanagement/summary/summary-justification.html',
        bindings: {
            justification: '<'
        }
    });
