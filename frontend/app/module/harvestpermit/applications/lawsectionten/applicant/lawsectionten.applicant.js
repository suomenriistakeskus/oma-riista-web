...
angular.module('app.harvestpermit.application.lawsectionten.applicant', ['app.metadata'])
    .config(function ($stateProvider) {
        $stateProvider
            .state('profile.permitwizard.lawsectionten.applicant', {
                url: '/applicant',
            ...
            .state('jht.decision.application.wizard.lawsectionten.applicant', {
                url: '/applicant',
                templateUrl: 'harvestpermit/applications/lawsectionten/applicant/applicant.html',
                controller: 'LawSectionTenPermitWizardApplicantController',
                controllerAs: '$ctrl',
    ...
    .controller('LawSectionTenPermitWizardApplicantController', function ($state,
                                                                        wizard, application, LawSectionTenPermitApplication,
        ...
        $ctrl.save = function () {
            ...
            return LawSectionTenPermitApplication.updatePermitHolder({id: application.id}, $ctrl.permitHolder).$promise;
        };
    });
