...
angular.module('app.harvestpermit.application.lawsectionten.europeanbeaver.population', ['app.metadata'])

    .controller('EuropeanBeaverPopulationController', function ($scope, LawSectionTenPermitApplication, ApplicationWizardNavigationHelper,
    ...
    .component('europeanBeaverApplicationSummaryPopulation', {
        templateUrl: 'harvestpermit/applications/lawsectionten/europeanbeaver/summary-population.html',
        bindings: {
            application: '<'
        }
    });
