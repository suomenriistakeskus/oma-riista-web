...
angular.module('app.harvestpermit.application.lawsectionten.summary', ['app.metadata'])
    .config(function ($stateProvider) {
        $stateProvider
            .state('profile.permitwizard.lawsectionten.summary', {
                url: '/summary',
            ...
            .state('jht.decision.application.wizard.lawsectionten.summary', {
                url: '/summary',
                templateUrl: 'harvestpermit/applications/lawsectionten/summary/summary.html',
                controller: 'LawSectionTenPermitWizardSummaryController',
                controllerAs: '$ctrl',
    ...
    .controller('LawSectionTenPermitWizardSummaryController', function ($scope, $q, $translate, $filter, dialogs,
    ...
    .component('lawsectiontenApplicationSummary', {
        templateUrl: 'harvestpermit/applications/lawsectionten/summary/summary-accordion.html',
        bindings: {
            application: '<'
        },
        controller: function () {
    ...
    .component('lawsectiontenApplicationSummarySpecies', {
        templateUrl: 'harvestpermit/applications/lawsectionten/summary/summary-species.html',
        bindings: {
            species: '<'
        }
    })

    .component('lawsectiontenApplicationSummaryArea', {
        templateUrl: 'harvestpermit/applications/lawsectionten/summary/summary-area.html',
        bindings: {
            application: '<',
            attachments: '<',
            baseUri: '<'
    ...
    .component('lawsectiontenApplicationSummaryPeriods', {
        templateUrl: 'harvestpermit/applications/lawsectionten/summary/summary-periods.html',
        bindings: {
            period: '<'
        }
    })
    ...
    .component('lawsectiontenApplicationSummaryPopulation', {
        templateUrl: 'harvestpermit/applications/lawsectionten/summary/summary-population.html',
        bindings: {
            population: '<'
        }
    })
