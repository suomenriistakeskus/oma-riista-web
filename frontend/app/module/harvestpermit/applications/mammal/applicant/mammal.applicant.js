...
angular.module('app.harvestpermit.application.mammal.applicant', ['app.metadata'])
    .config(function ($stateProvider) {
        $stateProvider
            .state('profile.permitwizard.mammal.applicant', {
                url: '/applicant',
            ...
            .state('jht.decision.application.wizard.mammal.applicant', {
                url: '/applicant',
                templateUrl: 'harvestpermit/applications/mammal/applicant/applicant.html',
                controller: 'MammalPermitWizardApplicantController',
                controllerAs: '$ctrl',
    ...
    .controller('MammalPermitWizardApplicantController', function ($state,
                                                                   wizard, application, MammalPermitApplication,
        ...
        $ctrl.save = function () {
            ...
            return MammalPermitApplication.updatePermitHolder({id: application.id}, $ctrl.permitHolder).$promise;
        };
    });
