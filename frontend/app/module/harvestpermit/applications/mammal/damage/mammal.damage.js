...
angular.module('app.harvestpermit.application.mammal.damage', ['app.metadata'])
    .config(function ($stateProvider) {
        $stateProvider
            .state('profile.permitwizard.mammal.damage', {
                url: '/damage',
            ...
            .state('jht.decision.application.wizard.mammal.damage', {
                url: '/damage',
                templateUrl: 'harvestpermit/applications/wizard/damage/damage.html',
                controller: 'DerogationPermitWizardDamageController',
                controllerAs: '$ctrl',
