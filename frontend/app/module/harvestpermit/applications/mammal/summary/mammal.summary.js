...
angular.module('app.harvestpermit.application.mammal.summary', ['app.metadata'])
    .config(function ($stateProvider) {
        $stateProvider
            .state('profile.permitwizard.mammal.summary', {
                url: '/summary',
            ...
            .state('jht.decision.application.wizard.mammal.summary', {
                url: '/summary',
                templateUrl: 'harvestpermit/applications/mammal/summary/summary.html',
                controller: 'MammalPermitWizardSummaryController',
                controllerAs: '$ctrl',
    ...
    .controller('MammalPermitWizardSummaryController', function ($scope, $q, $translate, $filter, dialogs,
    ...
    .component('mammalApplicationSummary', {
        templateUrl: 'harvestpermit/applications/mammal/summary/summary-accordion.html',
        bindings: {
            application: '<'
        },
        controller: function () {
    ...
    .component('mammalApplicationSummarySpecies', {
        templateUrl: 'harvestpermit/applications/mammal/summary/summary-species.html',
        bindings: {
            species: '<'
        }
    })

    .component('mammalApplicationSummaryArea', {
        templateUrl: 'harvestpermit/applications/mammal/summary/summary-area.html',
        bindings: {
            application: '<',
            attachments: '<',
            baseUri: '<'
    ...
    .component('mammalApplicationSummaryReasons', {
        templateUrl: 'harvestpermit/applications/mammal/summary/summary-reasons.html',
        bindings: {
            reasons: '<'
        }
    })

    .component('mammalApplicationSummaryPeriods', {
        templateUrl: 'harvestpermit/applications/mammal/summary/summary-periods.html',
        bindings: {
            periods: '<',
            years: '<',
    ...
    .component('mammalApplicationSummaryPopulation', {
        templateUrl: 'harvestpermit/applications/mammal/summary/summary-population.html',
        bindings: {
            population: '<'
        }
    })
