...
angular.module('app.harvestpermit.application.weapontransportation.summary', ['app.metadata'])
    .config(function ($stateProvider) {
        $stateProvider
            .state('profile.permitwizard.weapontransportation.summary', {
                url: '/summary',
            ...
            .state('jht.decision.application.wizard.weapontransportation.summary', {
                url: '/summary',
                templateUrl: 'harvestpermit/applications/weapontransportation/summary/summary.html',
                controller: 'WeaponTransportationPermitWizardSummaryController',
                controllerAs: '$ctrl',
    ...
    .controller('WeaponTransportationPermitWizardSummaryController', function ($scope, $q, $translate, $filter, dialogs,
    ...
    .component('weaponTransportationApplicationSummary', {
        templateUrl: 'harvestpermit/applications/weapontransportation/summary/summary-accordion.html',
        bindings: {
            application: '<'
        },
        controller: function () {
    ...
    .component('weaponTransportationApplicationSummaryArea', {
        templateUrl: 'harvestpermit/applications/weapontransportation/summary/summary-area.html',
        bindings: {
            application: '<',
            attachments: '<',
            baseUri: '<'
    ...
    .component('weaponTransportationApplicationSummaryReason', {
        templateUrl: 'harvestpermit/applications/weapontransportation/summary/summary-reason.html',
        bindings: {
            reason: '<'
        }
    })

    .component('weaponTransportationApplicationSummaryJustification', {
        templateUrl: 'harvestpermit/applications/weapontransportation/summary/summary-justification.html',
        bindings: {
            justification: '<'
        }
    });
