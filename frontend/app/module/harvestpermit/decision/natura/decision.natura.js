...
angular.module('app.harvestpermit.decision.natura', [])
    .config(function ($stateProvider) {
        ...
        function createApplicationLocationMarker(geoLocation, WGS84, $translate) {
        ...
        $stateProvider.state('jht.decision.natura', {
            ...
            resolve: {
                ...
                applicationLocations: function ($translate, WGS84, Helpers, applicationId, category,
                                                DogUnleashApplication, DogDisturbanceApplication, BirdPermitApplication) {
                    switch (category) {
                        case 'DOG_UNLEASH':
    ...
    .controller('DecisionNaturaController', function ($filter, $scope, $translate, MapDefaults, MapState, MapUtil, leafletData, Markers,
                                  GIS, WGS84, decision, applicationId, applicationLocations, NaturaAreaMarkerService,
                                  NotificationService, MeasureDistanceTool, MeasureAreaTool) {
        var $ctrl = this;
