...
public class DERO_Methods implements Equals2, HashCode2, ToString2
{
    ...
    public DERO_Methods withMethod(String... values) {
        if (values!= null) {
    ...
    public DERO_Methods withMethod(Collection<String> values) {
        if (values!= null) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DERO_Methods that = ((DERO_Methods) object);
        {
            List<String> lhsMethod;
            lhsMethod = (((this.method!= null)&&(!this.method.isEmpty()))?this.getMethod():null);
            List<String> rhsMethod;
