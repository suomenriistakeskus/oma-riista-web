 ...
 *         &lt;element name="source" type="{http://riista.fi/integration/luke/export/deerharvests/2020/03}source"/&gt;
...
@XmlType(name = "geoLocation", namespace = "http://riista.fi/integration/luke/export/deerharvests/2020/03", propOrder = {
    "latitude",
    "longitude",
    "source",
    "accuracy",
...
public class LED_GeoLocation {
     ...
     *     
     */
    public void setSource(LED_Source value) {
        this.source = value;
    }
