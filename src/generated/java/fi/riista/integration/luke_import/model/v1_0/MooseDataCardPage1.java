 ...
 *         &lt;element name="_Ilmoitus_on_ajalta_1" type="{http://www.w3.org/2001/XMLSchema}date"/&gt;
 *         &lt;element name="_Ilmoitus_on_ajalta_2" type="{http://www.w3.org/2001/XMLSchema}date"/&gt;
...
public class MooseDataCardPage1 implements Cloneable, Copyable, PartialCopyable, ToString2
{
    ...
    @XmlElement(name = "_Ilmoitus_on_ajalta_1", required = true, type = String.class, nillable = true)
    @XmlJavaTypeAdapter(LocalDateAdapter.class)
    @XmlSchemaType(name = "date")
    protected LocalDate reportingPeriodBeginDate;
    @XmlElement(name = "_Ilmoitus_on_ajalta_2", required = true, type = String.class, nillable = true)
    @XmlJavaTypeAdapter(LocalDateAdapter.class)
    @XmlSchemaType(name = "date")
    protected LocalDate reportingPeriodEndDate;
    ...
    public MooseDataCardPage1(final MooseDataCardPage1 _other) {
        ...
        this.reportingPeriodBeginDate = _other.reportingPeriodBeginDate;
        this.reportingPeriodEndDate = _other.reportingPeriodEndDate;
    ...
    public MooseDataCardPage1(final MooseDataCardPage1 _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        ...
        final PropertyTree reportingPeriodBeginDatePropertyTree = ((_propertyTree == null)?null:_propertyTree.get("reportingPeriodBeginDate"));
        if (((_propertyTreeUse == PropertyTreeUse.INCLUDE)?(reportingPeriodBeginDatePropertyTree!= null):((reportingPeriodBeginDatePropertyTree == null)||(!reportingPeriodBeginDatePropertyTree.isLeaf())))) {
            this.reportingPeriodBeginDate = _other.reportingPeriodBeginDate;
        }
        final PropertyTree reportingPeriodEndDatePropertyTree = ((_propertyTree == null)?null:_propertyTree.get("reportingPeriodEndDate"));
        if (((_propertyTreeUse == PropertyTreeUse.INCLUDE)?(reportingPeriodEndDatePropertyTree!= null):((reportingPeriodEndDatePropertyTree == null)||(!reportingPeriodEndDatePropertyTree.isLeaf())))) {
            this.reportingPeriodEndDate = _other.reportingPeriodEndDate;
        }
    ...
    /**
     * Gets the value of the reportingPeriodBeginDate property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the reportingPeriodBeginDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setReportingPeriodBeginDate(LocalDate value) {
        this.reportingPeriodBeginDate = value;
    }
     ...
     *     
     */
    public void setReportingPeriodEndDate(LocalDate value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            LocalDate theReportingPeriodBeginDate;
            theReportingPeriodBeginDate = this.getReportingPeriodBeginDate();
            strategy.appendField(locator, this, "reportingPeriodBeginDate", buffer, theReportingPeriodBeginDate, (this.reportingPeriodBeginDate!= null));
        }
        {
            LocalDate theReportingPeriodEndDate;
            theReportingPeriodEndDate = this.getReportingPeriodEndDate();
            strategy.appendField(locator, this, "reportingPeriodEndDate", buffer, theReportingPeriodEndDate, (this.reportingPeriodEndDate!= null));
        }
        {
    ...
    public MooseDataCardPage1 withReportingPeriodBeginDate(LocalDate value) {
        setReportingPeriodBeginDate(value);
        return this;
    }

    public MooseDataCardPage1 withReportingPeriodEndDate(LocalDate value) {
    ...
    public MooseDataCardPage1 createCopy() {
        ...
        _newObject.reportingPeriodBeginDate = this.reportingPeriodBeginDate;
        _newObject.reportingPeriodEndDate = this.reportingPeriodEndDate;
        ...
        extends com.kscs.util.jaxb.Selector<TRoot, TParent>
    {
        ...
        private com.kscs.util.jaxb.Selector<TRoot, MooseDataCardPage1 .Selector<TRoot, TParent>> reportingPeriodBeginDate = null;
        private com.kscs.util.jaxb.Selector<TRoot, MooseDataCardPage1 .Selector<TRoot, TParent>> reportingPeriodEndDate = null;
        ...
        public Map<String, PropertyTree> buildChildren() {
            ...
            if (this.reportingPeriodBeginDate!= null) {
                products.put("reportingPeriodBeginDate", this.reportingPeriodBeginDate.init());
            }
            if (this.reportingPeriodEndDate!= null) {
                products.put("reportingPeriodEndDate", this.reportingPeriodEndDate.init());
            }
        ...
        public com.kscs.util.jaxb.Selector<TRoot, MooseDataCardPage1 .Selector<TRoot, TParent>> reportingPeriodBeginDate() {
            return ((this.reportingPeriodBeginDate == null)?this.reportingPeriodBeginDate = new com.kscs.util.jaxb.Selector<TRoot, MooseDataCardPage1 .Selector<TRoot, TParent>>(this._root, this, "reportingPeriodBeginDate"):this.reportingPeriodBeginDate);
        }

        public com.kscs.util.jaxb.Selector<TRoot, MooseDataCardPage1 .Selector<TRoot, TParent>> reportingPeriodEndDate() {
            return ((this.reportingPeriodEndDate == null)?this.reportingPeriodEndDate = new com.kscs.util.jaxb.Selector<TRoot, MooseDataCardPage1 .Selector<TRoot, TParent>>(this._root, this, "reportingPeriodEndDate"):this.reportingPeriodEndDate);
        }
