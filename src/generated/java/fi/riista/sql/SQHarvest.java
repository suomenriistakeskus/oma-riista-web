...
public class SQHarvest extends RelationalPathSpatial<SQHarvest> {
    ...
    public final com.querydsl.sql.ForeignKey<SQHarvestReport> harvestHarvestReportFk = createForeignKey(harvestReportId, "harvest_report_id");
    ...
    public final com.querydsl.sql.ForeignKey<SQHarvestReportFields> harvestHarvestHarvestReportFieldsFk = createForeignKey(harvestReportFieldsId, "harvest_report_fields_id");
    ...
    public void addMetadata() {
        ...
        addMetadata(approverToHuntingDayId, ColumnMetadata.named("approver_to_hunting_day_id").withIndex(48).ofType(Types.BIGINT).withSize(19));
        ...
        addMetadata(groupHuntingDayId, ColumnMetadata.named("group_hunting_day_id").withIndex(41).ofType(Types.BIGINT).withSize(19));
        addMetadata(harvestId, ColumnMetadata.named("harvest_id").withIndex(1).ofType(Types.BIGINT).withSize(19).notNull());
        addMetadata(harvestPermitId, ColumnMetadata.named("harvest_permit_id").withIndex(37).ofType(Types.BIGINT).withSize(19));
        addMetadata(harvestQuotaId, ColumnMetadata.named("harvest_quota_id").withIndex(39).ofType(Types.BIGINT).withSize(19));
        addMetadata(harvestReportFieldsId, ColumnMetadata.named("harvest_report_fields_id").withIndex(36).ofType(Types.BIGINT).withSize(19));
        addMetadata(harvestReportId, ColumnMetadata.named("harvest_report_id").withIndex(35).ofType(Types.BIGINT).withSize(19));
        ...
        addMetadata(harvestSeasonId, ColumnMetadata.named("harvest_season_id").withIndex(38).ofType(Types.BIGINT).withSize(19));
        ...
        addMetadata(moderatorOverride, ColumnMetadata.named("moderator_override").withIndex(47).ofType(Types.BIT).withSize(1).notNull());
        addMetadata(modificationTime, ColumnMetadata.named("modification_time").withIndex(7).ofType(Types.TIMESTAMP).withSize(35).withDigits(6).notNull());
        addMetadata(modifiedByUserId, ColumnMetadata.named("modified_by_user_id").withIndex(5).ofType(Types.BIGINT).withSize(19));
        addMetadata(municipalityCode, ColumnMetadata.named("municipality_code").withIndex(46).ofType(Types.CHAR).withSize(3));
        addMetadata(permittedMethodDescription, ColumnMetadata.named("permitted_method_description").withIndex(45).ofType(Types.VARCHAR).withSize(255));
        addMetadata(permittedMethodOther, ColumnMetadata.named("permitted_method_other").withIndex(44).ofType(Types.BIT).withSize(1));
        addMetadata(permittedMethodTapeRecorders, ColumnMetadata.named("permitted_method_tape_recorders").withIndex(42).ofType(Types.BIT).withSize(1));
        addMetadata(permittedMethodTraps, ColumnMetadata.named("permitted_method_traps").withIndex(43).ofType(Types.BIT).withSize(1));
        ...
        addMetadata(pointOfTimeApprovedToHuntingDay, ColumnMetadata.named("point_of_time_approved_to_hunting_day").withIndex(49).ofType(Types.TIMESTAMP).withSize(35).withDigits(6));
        ...
        addMetadata(stateAcceptedToHarvestPermit, ColumnMetadata.named("state_accepted_to_harvest_permit").withIndex(40).ofType(Types.VARCHAR).withSize(255));
    }
