...
public class SQHarvestSeason extends RelationalPathSpatial<SQHarvestSeason> {
    ...
    public final com.querydsl.sql.ForeignKey<SQGameSpecies> harvestSeasonGameSpeciesFk = createForeignKey(gameSpeciesId, "game_species_id");
    ...
    public SQHarvestSeason(String variable, String schema) {
        super(SQHarvestSeason.class, forVariable(variable), schema, "harvest_season");
        addMetadata();
    }
    ...
    public void addMetadata() {
        addMetadata(beginDate, ColumnMetadata.named("begin_date").withIndex(9).ofType(Types.DATE).withSize(13).notNull());
        ...
        addMetadata(endDate, ColumnMetadata.named("end_date").withIndex(10).ofType(Types.DATE).withSize(13).notNull());
        addMetadata(endDate2, ColumnMetadata.named("end_date2").withIndex(15).ofType(Types.DATE).withSize(13));
        addMetadata(endOfReportingDate, ColumnMetadata.named("end_of_reporting_date").withIndex(11).ofType(Types.DATE).withSize(13).notNull());
        addMetadata(endOfReportingDate2, ColumnMetadata.named("end_of_reporting_date2").withIndex(16).ofType(Types.DATE).withSize(13));
        addMetadata(gameSpeciesId, ColumnMetadata.named("game_species_id").withIndex(17).ofType(Types.BIGINT).withSize(19).notNull());
