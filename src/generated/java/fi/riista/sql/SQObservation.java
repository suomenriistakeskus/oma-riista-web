...
public class SQObservation extends RelationalPathSpatial<SQObservation> {

    private static final long serialVersionUID = 1787806119;

    public static final SQObservation gameObservation = new SQObservation("game_observation");
    ...
    public final com.querydsl.sql.PrimaryKey<SQObservation> gameObservationPkey = createPrimaryKey(gameObservationId);
    ...
    public SQObservation(String variable) {
        super(SQObservation.class, forVariable(variable), "public", "game_observation");
        addMetadata();
    }

    public SQObservation(String variable, String schema, String table) {
        super(SQObservation.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public SQObservation(Path<? extends SQObservation> path) {
        super(path.getType(), path.getMetadata(), "public", "game_observation");
        addMetadata();
    }

    public SQObservation(PathMetadata metadata) {
        super(SQObservation.class, metadata, "public", "game_observation");
        addMetadata();
    }
