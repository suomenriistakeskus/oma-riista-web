...
public class BirdPermitApplicationApiResource {
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    @PostMapping(value = "/{applicationId:\\d+}/cause", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @CacheControl(policy = CachePolicy.NO_CACHE)
    @GetMapping(value = "/{applicationId:\\d+}/cause", produces = MediaType.APPLICATION_JSON_VALUE)
