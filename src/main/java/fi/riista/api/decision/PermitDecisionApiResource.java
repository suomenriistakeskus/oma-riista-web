...
public class PermitDecisionApiResource {
    ...
    @CacheControl(policy = CachePolicy.NO_CACHE)
    @GetMapping(value = "{decisionId:\\d+}/hasarea", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @CacheControl(policy = CachePolicy.NO_CACHE)
    @GetMapping(value = "{decisionId:\\d+}/methods/{gameSpeciesCode:\\d+}", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    @PostMapping(value = "{decisionId:\\d+}/methods/{gameSpeciesCode:\\d+}", consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @CacheControl(policy = CachePolicy.NO_CACHE)
    @GetMapping(value = "{decisionId:\\d+}/legal", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    @PostMapping(value = "{decisionId:\\d+}/legal", consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @CacheControl(policy = CachePolicy.NO_CACHE)
    @PostMapping(value = "{decisionId:\\d+}/generate/{sectionId:\\w+}", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @CacheControl(policy = CachePolicy.NO_CACHE)
    @GetMapping(value = "{decisionId:\\d+}/payment", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    public PermitDecisionPublishSettingsDTO getPublishSettings(final @PathVariable long decisionId) {
    ...
    public PermitDecisionAppealSettingsDTO getAppealSettings(final @PathVariable long decisionId) {
    ...
    public void updateAppealSettings(final @PathVariable long decisionId,
                                     final @Valid @RequestBody PermitDecisionAppealSettingsDTO dto) {
        dto.setDecisionId(decisionId);
    ...
    public void lockDecision(final @PathVariable long decisionId) {
        ...
        permitDecisionRevisionFeature.createDecisionRevision(decisionId);
    }
    ...
    @GetMapping(value = "{decisionId:\\d+}/action", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
