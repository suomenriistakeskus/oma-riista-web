...
public class PermitDecisionDerogationApiResource {
    ...
    @GetMapping(value = "{decisionId:\\d+}/reasons", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @CacheControl(policy = CachePolicy.NO_CACHE)
    @GetMapping(value = "{decisionId:\\d+}/area", produces = MediaType.APPLICATION_JSON_VALUE)
