...
public class NominationDecisionRevisionReceiver extends LifecycleEntity<Long> {
    ...
    public static final String ID_COLUMN_NAME = "nomination_decision_revision_receiver_id";
    ...
    /*package*/ NominationDecisionRevisionReceiver() {
    }

    public NominationDecisionRevisionReceiver(final NominationDecisionRevision decisionRevision,
        ...
        this.receiverType = requireNonNull(receiverType);
        this.email = StringUtils.trimToNull(email);
        this.name = requireNonNull(StringUtils.trimToNull(name));
        this.scheduledDate = requireNonNull(scheduledDate);
    ...
    public void setDecisionRevision(final NominationDecisionRevision decisionRevision) {
        CriteriaUtils.updateInverseCollection(NominationDecisionRevision_.receivers, this, this.decisionRevision, decisionRevision);
