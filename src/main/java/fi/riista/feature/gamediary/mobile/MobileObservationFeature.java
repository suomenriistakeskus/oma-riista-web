...
public class MobileObservationFeature {
    ...
    public MobileObservationDTO createObservation(@Nonnull final MobileObservationDTO dto) {
        ...
        clearAmountWithinMooseOrDeerHunting(dto);
    ...
    private static void clearAmountWithinMooseOrDeerHunting(final MobileObservationDTO dto) {
        if (dto.getObservationCategory() != NORMAL && dto.getAmount() != null) {
            dto.setAmount(null);
