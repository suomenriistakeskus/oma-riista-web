...
public class GISPropertyExcelChangedView extends AbstractXlsxView {

    private static final String COLUMN_HEADER_PREFIX = "GISPropertyChangedExcel.";
    ...
    public GISPropertyExcelChangedView(final EnumLocaliser localiser,
