...
public class HarvestReportListNotification {
    private static final LocalisedString TEMPLATE = new LocalisedString(
            "email_harvest_report_list", "email_harvest_report_list.sv");
    ...
    public HarvestReportListNotification(
    ...
    public HarvestReportListNotification withReport(HarvestReport report) {
        this.report = report;
    ...
    public HarvestReportListNotification withPermit(final HarvestPermit permit) {
        if (permit != null) {
    ...
    public HarvestReportListNotification withSummaries(Map<GameSpecies, SpecimenSummary> summaries) {
        this.summaries = summaries;
        return this;
    }


    public HarvestReportListNotification withEmail(String email) {
        this.email = email;
    ...
    public static class SpecimenSummary {
        ...
        public static Map<GameSpecies, SpecimenSummary> create(Set<Harvest> harvests) {
