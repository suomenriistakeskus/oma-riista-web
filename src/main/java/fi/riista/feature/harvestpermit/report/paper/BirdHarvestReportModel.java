...
public class BirdHarvestReportModel {
    public static BirdHarvestReportModel create(final PermitDecision permitDecision,
        ...
        return new BirdHarvestReportModel(speciesList, recipientAddress,
    ...
    private static List<SpeciesAndPermitNumber> buildSpeciesList(
        ...
        speciesAmountList.stream()
                ...
                .forEach((year, amountList) -> speciesList.addAll(buildSpeciesListForYear(permitDecision, year, amountList)));
    ...
    public BirdHarvestReportModel(final List<SpeciesAndPermitNumber> speciesList,
