...
public final class HarvestRegistryDerogationMapper {
    ...
    private static HarvestRegistryItem createItemWithNoSpecimenInfo(final Harvest harvest,
        ...
        final HarvestRegistryItem item =
                HarvestRegistryItemMapper.createFrom(harvest, actualShooter, rkaCode, rhyCode);
