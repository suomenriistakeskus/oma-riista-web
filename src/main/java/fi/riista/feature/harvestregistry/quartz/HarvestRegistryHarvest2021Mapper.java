...
/**
 * For 2021 onwards, grey seal extra fields are no longer valid, same fields shall be applied as with ringed seal.
 */
public class HarvestRegistryHarvest2021Mapper implements HarvestRegistryTransformUtils {

    public static final HarvestRegistryHarvest2021Mapper INSTANCE = new HarvestRegistryHarvest2021Mapper();
    ...
    private static final Map<Integer, Set<HarvestRegistryExtraAttributes>> SPECIES_TO_ATTRIBUTES_MAPPING =
            ImmutableMap.<Integer, Set<HarvestRegistryExtraAttributes>>builder()
                    ...
                    .put(GameSpecies.OFFICIAL_CODE_GREYLAG_GOOSE, ImmutableSet.of(MUNICIPALITY))
                    // Peltopyy
    ...
    private HarvestRegistryHarvest2021Mapper() {}
}
