...
public class HuntingClubAreaPrintFeature {
    private static final Logger LOG = LoggerFactory.getLogger(HuntingClubAreaPrintFeature.class);
    ...
    public String getExportFileName(final long clubAreaId, final Locale locale) {
    ...
    @Transactional(readOnly = true)
    public FeatureCollection exportFeatures(final long clubAreaId, final Locale locale) {
        final HuntingClubArea huntingClubArea = requireEntityService
                .requireHuntingClubArea(clubAreaId, EntityPermission.READ);
    ...
    public byte[] printGeoJson(final HuntingClubAreaPrintRequestDTO dto,
