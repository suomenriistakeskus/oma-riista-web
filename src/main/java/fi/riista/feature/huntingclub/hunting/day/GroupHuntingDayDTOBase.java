...
public abstract class GroupHuntingDayDTOBase<SELF> extends BaseEntityDTO<Long> {
    ...
    public SELF withNumberOfHounds(final Integer numberOfHounds) {
        setNumberOfHounds(numberOfHounds);
        return self();
    }

    public SELF withStartAndEndDate(final LocalDate startDate, final LocalDate endDate) {
