...
public class SharedPermitMapFeature {
    ...
    public List<HarvestDTO> listHarvest(final long harvestPermitId, final int huntingYear, final int gameSpeciesCode) {
        ...
        final List<Harvest> harvests = getHarvestForPermit(harvestPermit, huntingYear, species);

        return sharedPermitHarvestDTOTransformer.apply(harvests, HarvestSpecVersion.CURRENTLY_SUPPORTED);
    }
