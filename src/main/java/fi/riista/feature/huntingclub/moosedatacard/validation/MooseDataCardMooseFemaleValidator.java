...
public class MooseDataCardMooseFemaleValidator extends MooseDataCardHarvestValidator<MooseDataCardMooseFemale> {
    ...
    public MooseDataCardMooseFemaleValidator(@Nonnull final GeoLocation defaultCoordinates) {
        super(defaultCoordinates);
    }

    public MooseDataCardMooseFemaleValidator(
    ...
    public Validation<List<String>, MooseDataCardMooseFemale> validate(final MooseDataCardMooseFemale harvest) {
        return getCommonHarvestValidation(harvest).leftMap(Collections::singletonList);
    }
