...
import static fi.riista.feature.huntingclub.permit.endofhunting.moosesummary.MooseHuntingSummaryAuthorization.Role.PERMIT_CONTACT_PERSON;
...
public class MooseHuntingSummaryAuthorization extends AbstractEntityAuthorization<MooseHuntingSummary> {
    ...
    @Override
    public boolean hasPermission(@Nonnull final MooseHuntingSummary summary,
