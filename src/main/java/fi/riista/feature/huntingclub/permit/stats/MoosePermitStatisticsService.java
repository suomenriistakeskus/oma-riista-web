...
public class MoosePermitStatisticsService {
                ...
                .flatMap(permit -> {
                    ...
                    return partners.stream()
                            .map(partner -> {
                                ...
                                return createStatisticsDto(permitAmounts, permitIdToPermitLocked, permit, partner,
                                        summaries, false);
                            });
                })
    ...
    public List<MoosePermitStatisticsDTO> calculateByHolder(final Locale locale,
                                                            final int speciesCode,
                                                            final int huntingYear,
                                                            final MoosePermitStatisticsFeature.OrgType orgType,
    ...
    private List<HarvestPermit> findPermits(final MoosePermitStatisticsFeature.OrgType orgType,
                                            final String orgCode,
                                            final int speciesCode,
                                            final int huntingYear) {
