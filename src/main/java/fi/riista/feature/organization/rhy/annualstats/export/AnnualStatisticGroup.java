...
public enum AnnualStatisticGroup implements LocalisedEnum {
    ...
    SUBSIDY_SUMMARY(OVERVIEW, 1, asList(
            RHY_MEMBERS,
    ...
    OTHER_SUMMARY(OVERVIEW, 1, asList(
            HUNTER_EXAM_EVENTS,
    ...
    TRAINING_SUMMARY(TRAININGS, 4, asList(ALL_TRAINING_EVENTS, ALL_TRAINING_PARTICIPANTS)),

    // Overridden by TRAINING_SUMMARY
    TRAINING_SUMMARY_2017(TRAININGS, 4, asList(ALL_TRAINING_EVENTS_2017, ALL_TRAINING_PARTICIPANTS_2017)),

    HUNTER_EXAM_TRAINING(TRAININGS, 4, asList(HUNTER_EXAM_TRAINING_EVENTS, HUNTER_EXAM_TRAINING_PARTICIPANTS)),

    JHT_TRAINING(TRAININGS, 4, asList(
    ...
    HUNTER_TRAINING(TRAININGS, 4, asList(
    ...
    YOUTH_TRAINING(TRAININGS, 4, asList(
            SCHOOL_TRAINING_EVENTS,
            SCHOOL_TRAINING_PARTICIPANTS,
            COLLEGE_TRAINING_EVENTS,
            COLLEGE_TRAINING_PARTICIPANTS,
    ...
    OTHER_HUNTER_TRAINING(TRAININGS, 5, asList(
    ...
    OTHER_HUNTING_RELATED(MISC, 6, asList(
            HARVEST_PERMIT_APPLICATION_PARTNERS,
            MOOSELIKE_TAXATION_PLANNING_EVENTS,
            WOLF_TERRITORY_WORKGROUPS)),
    ...
    COMMUNICATION(MISC, 6, asList(INTERVIEWS, ANNOUNCEMENTS, OMARIISTA_ANNOUNCEMENTS, WWW, SOME_CHANNELS)),

    SHOOTING_RANGES(MISC, 6, asList(MOOSE_RANGES, SHOTGUN_RANGES, RIFLE_RANGES, OTHER_SHOOTING_RANGES)),
    ...
    METSAHALLITUS(MISC, 6, asList(SMALL_GAME_LICENSES_SOLD_BY_METSAHALLITUS)),

    PUBLIC_EVENTS(MISC, 6, asList(AnnualStatisticItem.PUBLIC_EVENTS, PUBLIC_EVENT_PARTICIPANTS));
