...
public class GameDamageInspectionEventExcelView extends AbstractXlsxView {
    ...
    private void createDataRows() {
        ...
        dtos.forEach(dto -> {
            ...
            excelHelper.appendFormula("FLOOR((%s-%s)*24,1)", -1, -2)
                    .withBorders(NONE, NONE, THIN, THIN).withFont(tableCellFont)
                    ...
                    .appendNumberCell(dto.getKilometers()).withFont(tableCellFont)
                    // Kilometer expenses
                    .appendFormulaWithConstant("%s*%s", tableCellCurrencyStyle, dto.getKilometerExpensesUnit().doubleValue(), -1)
