...
public final class SubsidyAllocation2019Stage4Rounding {
    ...
    private static class ComparableSubsidyAfterCompensation {
        ...
        public RhySubsidyRoundingStage4DTO toRoundingResult(final int givenRemainderEuros) {
            ...
            final BigDecimal finalSubsidy = givenRemainderEuros == 0
            ...
            return new RhySubsidyRoundingStage4DTO(
                    rhyCode,
                    new SubsidyRoundingDTO(subsidyAfterCompensation, finalSubsidy, givenRemainderEuros));
        }
    }

    private SubsidyAllocation2019Stage4Rounding() {
