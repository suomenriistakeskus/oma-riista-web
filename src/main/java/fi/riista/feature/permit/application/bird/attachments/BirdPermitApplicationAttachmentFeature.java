...
@Component
public class BirdPermitApplicationAttachmentFeature {
    ...
    public List<BirdPermitApplicationAttachmentDTO> listAttachments(
    ...
    public void updateAttachmentDescriptions(final long applicationId,
                                             final List<BirdPermitApplicationAttachmentDTO> dtoList) {
        final HarvestPermitApplication application = harvestPermitApplicationAuthorizationService.updateApplication(applicationId);
        ...
        for (final BirdPermitApplicationAttachmentDTO dto : dtoList) {
