...
public class BirdPermitApplicationDamageDTO {
    ...
    public BirdPermitApplicationDamageDTO() {
    }

    public BirdPermitApplicationDamageDTO(final HarvestPermitApplicationSpeciesAmount speciesAmount) {
