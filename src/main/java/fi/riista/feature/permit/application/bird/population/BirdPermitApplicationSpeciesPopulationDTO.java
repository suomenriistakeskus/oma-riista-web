...
public class BirdPermitApplicationSpeciesPopulationDTO {
    ...
    public BirdPermitApplicationSpeciesPopulationDTO() {
    }

    public BirdPermitApplicationSpeciesPopulationDTO(final HarvestPermitApplicationSpeciesAmount speciesAmount) {
