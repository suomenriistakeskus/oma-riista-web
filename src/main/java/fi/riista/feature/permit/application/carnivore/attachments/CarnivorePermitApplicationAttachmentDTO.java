...
public class CarnivorePermitApplicationAttachmentDTO {
    ...
    public CarnivorePermitApplicationAttachmentDTO() {
    }

    public CarnivorePermitApplicationAttachmentDTO(final @Nonnull HarvestPermitApplicationAttachment attachment) {
