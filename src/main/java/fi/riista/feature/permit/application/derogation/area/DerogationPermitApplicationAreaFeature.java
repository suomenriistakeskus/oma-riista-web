...
@Component
public class DerogationPermitApplicationAreaFeature {
    ...
    @Resource
    private DerogationPermitApplicationService derogationPermitApplicationService;
    ...
    public DerogationPermitApplicationAreaDTO getArea(final long applicationId) {
        final DerogationPermitApplicationAreaInfo carnivorePermitApplication =
                derogationPermitApplicationService.findForRead(applicationId);

        return DerogationPermitApplicationAreaDTO.createFrom(carnivorePermitApplication);
    }

    @Transactional
    public void updateProtectedArea(final long applicationId,
                                    final @NotNull DerogationPermitApplicationAreaDTO area) {
        derogationPermitApplicationService.update(applicationId, area);
    }

    // AREA ATTACHMENTS

    @Transactional
    public void addAreaAttachment(final DerogationPermitApplicationAddAreaAttachmentDTO dto) {
    ...
    private static MapPdfParameters createPdfParameters(final MapPdfModel model) {
