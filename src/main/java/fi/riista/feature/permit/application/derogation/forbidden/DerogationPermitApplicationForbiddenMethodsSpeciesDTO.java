...
public class DerogationPermitApplicationForbiddenMethodsSpeciesDTO {

    public DerogationPermitApplicationForbiddenMethodsSpeciesDTO() {
    }

    public DerogationPermitApplicationForbiddenMethodsSpeciesDTO(final @Nonnull HarvestPermitApplicationSpeciesAmount speciesAmount) {
