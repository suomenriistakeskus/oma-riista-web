...
public class DerogationPermitApplicationReasonService {
    ...
    public void updateDerogationReasons(final HarvestPermitApplication application,
        ...
        derogationPermitApplicationReasonRepository.saveAll(toAdd);
        derogationPermitApplicationReasonRepository.deleteAll(toDelete);
    ...
    private void assertCategory(final HarvestPermitCategory category) {
        Preconditions.checkArgument(
                category == HarvestPermitCategory.MAMMAL ||
                        category == HarvestPermitCategory.NEST_REMOVAL ||
                        category == HarvestPermitCategory.DEPORTATION ||
                        category == HarvestPermitCategory.RESEARCH);
