...
public class DogEventDisturbanceSummaryDTO implements Serializable {

    private DogEventDisturbanceSummaryDTO(final Builder builder) {
        this.id = builder.id;
        ...
        this.trainingEvent = builder.trainingEvent;
        this.testEvent = builder.testEvent;
    }

    public static DogEventDisturbanceSummaryDTO create(final @Nonnull HarvestPermitApplication application,
                                                       final @Nonnull DogEventApplication dogEventApplication,
                                                       final DogEventDisturbanceDTO trainingEvent,
                                                       final DogEventDisturbanceDTO testEvent) {
        ...
        return new Builder()
                ...
                .withTrainingEvent(trainingEvent)
                .withTestEvent(testEvent)
                .build();
    }
    ...
    private final DogEventDisturbanceDTO trainingEvent;
    private final DogEventDisturbanceDTO testEvent;
    ...
    public DogEventDisturbanceDTO getTrainingEvent() {
        return trainingEvent;
    }

    public DogEventDisturbanceDTO getTestEvent() {
        return testEvent;
    }
    ...
    public static final class Builder {
        ...
        // From DogEventCarnivore
        private DogEventDisturbanceDTO trainingEvent;
        private DogEventDisturbanceDTO testEvent;
        ...
        public Builder withTrainingEvent(final DogEventDisturbanceDTO trainingEvent) {

            this.trainingEvent = trainingEvent;
            return this;
        }

        public Builder withTestEvent(final DogEventDisturbanceDTO testEvent) {

            this.testEvent = testEvent;
            return this;
        }

        public DogEventDisturbanceSummaryDTO build() {

            return new DogEventDisturbanceSummaryDTO(this);
        }
    }
}