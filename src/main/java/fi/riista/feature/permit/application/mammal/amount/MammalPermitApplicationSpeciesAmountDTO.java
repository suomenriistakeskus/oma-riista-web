...
public class MammalPermitApplicationSpeciesAmountDTO {
    private static final int MAX_SPECIES_AMOUNT = 100_000;
    private static final int MIN_SPECIES_AMOUNT = 1;

    public MammalPermitApplicationSpeciesAmountDTO() {
    }

    public MammalPermitApplicationSpeciesAmountDTO(final @Nonnull HarvestPermitApplicationSpeciesAmount speciesAmount) {
    ...
    public boolean isValidSpecies() {
        return GameSpecies.isMammalSpecies(gameSpeciesCode);
    }
