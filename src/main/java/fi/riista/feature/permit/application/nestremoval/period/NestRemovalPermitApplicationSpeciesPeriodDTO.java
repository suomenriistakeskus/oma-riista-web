...
public class NestRemovalPermitApplicationSpeciesPeriodDTO implements HasBeginAndEndDate {

    public NestRemovalPermitApplicationSpeciesPeriodDTO() {}

    public NestRemovalPermitApplicationSpeciesPeriodDTO(final @Nonnull HarvestPermitApplicationSpeciesAmount speciesAmount) {
