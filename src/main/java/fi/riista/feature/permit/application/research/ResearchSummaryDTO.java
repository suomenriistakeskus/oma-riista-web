...
public class ResearchSummaryDTO {
    ...
    private ResearchSummaryDTO(final @Nonnull Builder builder) {
    ...
    public static ResearchSummaryDTO create(final @Nonnull HarvestPermitApplication entity,
                                            final @Nonnull ResearchPermitApplication researchPermitApplication,
        ...
        return new Builder()
                ...
                .withReasons(Optional.ofNullable(reasonsDTO)
                        .orElse(null))
                .withForbiddenMethods(Optional.ofNullable(researchPermitApplication.getForbiddenMethods())
                        .map(forbiddenMethod -> DerogationPermitApplicationForbiddenMethodsDTO.createFrom(forbiddenMethod,
                                entity.getSpeciesAmounts().stream()
                                        ...
                                        .collect(Collectors.toList())))
                        .orElse(null))
                .withArea(DerogationPermitApplicationAreaDTO.createFrom(researchPermitApplication))
                ...
                .withJustification(researchPermitApplication.getJustification())
                .build();
    }
    ...
    private final List<ResearchSpeciesAmountDTO> speciesAmounts;
    private final List<ResearchSpeciesPeriodDTO> speciesPeriods;
    ...
    public List<ResearchSpeciesAmountDTO> getSpeciesAmounts() {
    ...
    public static final class Builder {
        ...
        private List<ResearchSpeciesAmountDTO> speciesAmounts;
        ...
        public Builder withSpeciesAmounts(List<ResearchSpeciesAmountDTO> speciesAmounts) {
            this.speciesAmounts = speciesAmounts;
            return this;
        }

        public Builder withSpeciesPeriods(List<ResearchSpeciesPeriodDTO> speciesPeriods) {
        ...
        public ResearchSummaryDTO build() {
            return new ResearchSummaryDTO(this);
        }
    }
}
