...
public class ResearchSpeciesPeriodDTO implements HasBeginAndEndDate {

    public ResearchSpeciesPeriodDTO() {
    }

    public ResearchSpeciesPeriodDTO(final @Nonnull HarvestPermitApplicationSpeciesAmount speciesAmount) {
