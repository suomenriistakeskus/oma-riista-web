...
public class PermitDecisionDeportationApplicationSummaryGenerator {
    ...
    private final DeportationSummaryDTO model;
    private final Locale locale;
    private final boolean swedish;
    private final MessageSource messageSource;
    private final Map<Integer, String> speciesNameIndex;

    public PermitDecisionDeportationApplicationSummaryGenerator(final DeportationSummaryDTO model,
                                                                final Locale locale,
    ...
    private void createAmounts(final StringBuilder sb) {
        ...
        for (final DeportationSpeciesAmountDTO speciesAmount : model.getSpeciesAmounts()) {
    ...
    private void createPeriods(final StringBuilder sb) {
        ...
        sb.append("---|---:\n");
        for (final DeportationSpeciesPeriodDTO speciesPeriod : model.getSpeciesPeriods()) {
    ...
    private void createReasons(final StringBuilder sb) {
        ...
        reasons.getReasons().forEach(lawSectionReason -> {
            ...
            if (lawSectionReason.getLawSection() == DerogationLawSection.SECTION_41A) {
                ...
                throw new IllegalArgumentException("Illegal law section for deportation application:" + lawSectionReason.getLawSection());
            }
            // reasons
    ...
    private void createPopulation(final StringBuilder sb) {
        sb.append(i18nKey("deportation.application.population.populationInfo"));
        sb.append("\n\n");

        sb.append(i18nKey("deportation.application.population.populationAmount"));
        sb.append("\n");
        ...
        sb.append("\n");
        sb.append(i18nKey("deportation.application.population.populationDescription"));
        sb.append("\n");
