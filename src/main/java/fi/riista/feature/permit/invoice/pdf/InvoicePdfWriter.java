...
public class InvoicePdfWriter implements Closeable {
    ...
    InvoicePdfWriter(final PDDocument document, final PDPage page) throws IOException {
    ...
    public InvoicePdfWriter marginLeftMm(float value) {
        this.posX = value * DOTS_PER_MM;
        return this;
    }

    public InvoicePdfWriter marginLeftRelative(int percents) {
        this.posX = page.getMediaBox().getUpperRightX() * percents / 100f;
        return this;
    }

    public InvoicePdfWriter topOffsetMm(float value) {
        this.posY = page.getMediaBox().getUpperRightY() - value * DOTS_PER_MM;
        return this;
    }

    public InvoicePdfWriter addVerticalSpaceMm(float value) {
        this.posY -= value * DOTS_PER_MM;
        return this;
    }

    public InvoicePdfWriter writeEmptyLine() {
        this.posY -= lineHeight;
        return this;
    }

    public InvoicePdfWriter normalFont() {
    ...
    public InvoicePdfWriter font(final PDType1Font font, final float fontSize, final float lineHeight) {
    ...
    public InvoicePdfWriter font(final PDType1Font font, final float fontSize) {
        this.activeFont = font;
        this.fontSize = fontSize;
    ...
    public InvoicePdfWriter boldFont() {
    ...
    public InvoicePdfWriter italicFont() {
    ...
    public InvoicePdfWriter smallFont() {
        this.activeFont = PDType1Font.TIMES_ITALIC;
        this.fontSize = 9f;
        this.lineHeight = 14f;
        return this;
    ...
    public InvoicePdfWriter writeLine(final String text) throws IOException {
        writeText(text, this.posX, this.posY);
        this.posY -= this.lineHeight;
        return this;
    }

    public InvoicePdfWriter writeParagraph(final String text) throws IOException {
        final float paragraphWidth = page.getMediaBox().getUpperRightX() - this.posX - 20;
        int start = 0;
        int end = 0;
    ...
    private InvoicePdfWriter writeText(final String text, final float tx, final float ty) throws IOException {
        this.contentStream.setFont(this.activeFont, this.fontSize);
        this.contentStream.beginText();
    ...
    public InvoicePdfWriter drawBox(final float top, final float left, final float widthMm, final float heightMm) throws IOException {
