...
public enum JyvitysExcelSummaryStaticField {
    ...
    SUMMARY_APPLICATION_NUMBER(new CellAddress("A5"), CellRangeAddress.valueOf("A5:A7")),
    SUMMARY_APPLICANT(new CellAddress("B5"), CellRangeAddress.valueOf("B5:B7")),
    SUMMARY_PRIVATE_LAND(new CellAddress("C5"), CellRangeAddress.valueOf("C5:C7")),
    SUMMARY_STATE_LAND(new CellAddress("D5"), CellRangeAddress.valueOf("D5:D7")),
    SUMMARY_TOTAL_LAND(new CellAddress("E5"), CellRangeAddress.valueOf("E5:E7")),
    SUMMARY_SHOOTERS(new CellAddress("G5"), CellRangeAddress.valueOf("F5:I5")),
    SUMMARY_SHOOTERS_ONLY_CLUB(new CellAddress("F6"), CellRangeAddress.valueOf("F6:F7")),
    SUMMARY_SHOOTERS_OTHER_CLUB_PASSIVE(new CellAddress("G6"), CellRangeAddress.valueOf("G6:G7")),
    SUMMARY_SHOOTERS_TOTAL(new CellAddress("H6"), CellRangeAddress.valueOf("H6:H7")),
    SUMMARY_SHOOTERS_TOTAL_PER_STATE_LAND(new CellAddress("I6"), CellRangeAddress.valueOf("I6:I7")),
    SUMMARY_APPLICATION_AMOUNT(new CellAddress("J5"), CellRangeAddress.valueOf("J5:J7")),
    SUMMARY_SUGGESTION_TOTAL(new CellAddress("N5"), CellRangeAddress.valueOf("N5:N7")),
    SUMMARY_SUGGESTION_ADULT(new CellAddress("O5"), CellRangeAddress.valueOf("O5:O7")),
    SUMMARY_SUGGESTION_CALF(new CellAddress("P5"), CellRangeAddress.valueOf("P5:P7")),
    SUMMARY_AREA_IN_OTHER_RHY(new CellAddress("Q5"), CellRangeAddress.valueOf("Q5:Q7")),
