...
public class PublicDTOFactory {
    ...
    public <T extends Enum<T> & HasOfficialCode> CodesetEntryDTO newCodesetEntryDTO(T enumValue) {
        return new CodesetEntryDTO(enumValue.getOfficialCode(), enumLocaliser.getLocalisedString(enumValue));
    }
