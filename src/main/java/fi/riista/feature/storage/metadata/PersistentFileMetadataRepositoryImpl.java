...
@Repository
public class PersistentFileMetadataRepositoryImpl implements PersistentFileMetadataRepositoryCustom {

    @Resource
    private JPQLQueryFactory jpqlQueryFactory;

    @Transactional(readOnly = true)
    public List<PersistentFileMetadata> findLatestDecisionAttachmentsMetadataForInformationRequest(int decisionNumber) {
