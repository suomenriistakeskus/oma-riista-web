...
public class MooselikeHarvestsObjectFactory {
    ...
    private static LEM_Overrides createOverrides(HuntingClub club, Map<Long, BasicClubHuntingSummary> clubOverrides) {
        ...
        o.setAdultMales(override.getNumberOfAdultMales());
        o.setAdultFemales(override.getNumberOfAdultFemales());
        o.setYoungMales(override.getNumberOfYoungMales());
        o.setYoungFemales(override.getNumberOfYoungFemales());
        o.setNonEdibleAdults(override.getNumberOfNonEdibleAdults());
        o.setNonEdibleYoung(override.getNumberOfNonEdibleYoungs());
