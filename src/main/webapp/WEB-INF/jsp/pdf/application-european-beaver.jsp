...
<div id="main-container">
    ...
    <div class="layout-container">
        ...
        <div class="col-2">
            <h2><fmt:message key="europeanbeaver.application.population.justification"/></h2>
            ...
            <h2><fmt:message key="europeanbeaver.application.population.damages"/></h2>

            <ul>
                <li>
                    <c:out value="${model.damagesCaused}"/>
                </li>
            </ul>

            <hr>

            <h2><fmt:message key="europeanbeaver.application.population.populationAmount"/></h2>
