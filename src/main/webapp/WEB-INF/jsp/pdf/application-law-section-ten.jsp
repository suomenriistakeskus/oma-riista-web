...
<div id="main-container">
    ...
    <div class="layout-container">
        ...
        <div class="col-2">
            <p><fmt:message key="lawsectionten.application.population.populationInfo"></fmt:message></p>
            <hr>
            <h2><fmt:message key="lawsectionten.application.population.populationAmount"/></h2>

            <ul>
                <li>
                    <c:out value="${speciesNames[model.population.gameSpeciesCode]}"/>:
                    <c:out value="${model.population.populationAmount}"/>
                </li>
            </ul>

            <hr>

            <h2><fmt:message key="lawsectionten.application.population.populationDescription"/></h2>

            <ul>
                    <li>
                        <c:out value="${speciesNames[model.population.gameSpeciesCode]}"/>:
                        <c:out value="${model.population.populationDescription}"/>
                    </li>
            </ul>
        </div>
    </div>
