...
<div id="main-container">
    ...
    <div class="layout-container">
        <div class="col-1">
            <fmt:message key="mammal.application.heading.reasons"/>
        </div>
        ...
        <div class="col-2">
            <c:forEach var="lawSection" items="${model.reasons.reasons}" varStatus="ls">
                ...
                <c:if test="${lawSection.lawSection == 'SECTION_41A'}">
                    <fmt:message key="mammal.application.reason.lawSection41a"></fmt:message>
                </c:if>
                <c:if test="${lawSection.lawSection == 'SECTION_41C'}">
                    <fmt:message key="mammal.application.reason.lawSection41c"></fmt:message>
                </c:if>
                <hr>
                <ul>
                    <c:forEach var="reason" items="${lawSection.lawSectionReasons}" varStatus="r">
                        <c:if test="${reason.checked }">
                            <li><fmt:message key="mammal.application.reason.${reason.reasonType}"></fmt:message></li>
                        </c:if>
                    </c:forEach>
                </ul>
                <br/>
    ...
    <div class="layout-container">
        ...
        <div class="col-2">
            ...
            <c:if test="${model.validityYears > 1}">
                <p>
                    <fmt:message key="mammal.application.reason.extendedPeriodGrounds"></fmt:message><br/>
                    <fmt:message
                            key="mammal.application.reason.extendedPeriodGrounds.${model.extendedPeriodGrounds}"></fmt:message><br/>

                </p>
                <p>
                    <fmt:message key="mammal.application.reason.protectedAreaName"></fmt:message><br/>
                    <c:out value="${model.protectedAreaName}"></c:out><br/>

                </p>
                <p>

                    <fmt:message key="mammal.application.reason.extendedPeriodGroundsDescription"></fmt:message><br/>
                    <c:out value="${model.extendedPeriodDescription}"></c:out><br/>
                </p>
            </c:if>
        </div>
    </div>
    ...
    <div class="layout-container">
        ...
        <div class="col-2">
            <p><fmt:message key="mammal.application.population.populationInfo"></fmt:message></p>
            <hr>
            <h2><fmt:message key="mammal.application.population.populationAmount"/></h2>
            ...
            <h2><fmt:message key="mammal.application.population.populationDescription"/></h2>
