        ...
        <div class="col-2">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td align="right">
                        <fmt:message key="nestremoval.application.nest"/>
                    </td>
                    <td align="right">
                        <fmt:message key="nestremoval.application.construction"/>
                    </td>
                    <td align="right">
                        <fmt:message key="nestremoval.application.egg"/>
                    </td>
                </tr>
                </thead>
                <tbody>
                <c:forEach var="spa" items="${model.speciesAmounts}" varStatus="s">
                    <tr>
                        ...
                        <td align="right">
                            <c:choose>
                                <c:when test="${spa.nestAmount != null}">
                                    <fmt:formatNumber value="${spa.nestAmount}" maxFractionDigits="0"/>
                                </c:when>
                                <c:otherwise>
                                    <c:out value="-"/>
                                </c:otherwise>
                        ...
                        <td align="right">
                            <c:choose>
                                <c:when test="${spa.constructionAmount != null}">
                                    <fmt:formatNumber value="${spa.constructionAmount}" maxFractionDigits="0"/>
                                </c:when>
                                <c:otherwise>
                                    <c:out value="-"/>
                                </c:otherwise>
