...
<div id="main-container">
    ...
    <div class="layout-container">
        ...
        <div class="col-2">
            ...
            <table>
                ...
                <tr>
                    <td>
                        <c:out value="${speciesNames[model.speciesAmount.gameSpeciesCode]}"/>
                    </td>
                    <td align="right">
                        <fmt:formatNumber value="${model.speciesAmount.amount}" maxFractionDigits="0"/>
                        &nbsp;
    ...
    <div class="layout-container">
        ...
        <div class="col-2">
            <table>
                ...
                <tr>
                    <td>
                        <c:out value="${speciesNames[model.speciesPeriod.gameSpeciesCode]}"/>
                    </td>
                    <td align="right">
                        <joda:format value="${model.speciesPeriod.beginDate}" pattern="d.M.yyyy"/>
                        &dash;
                        <joda:format value="${model.speciesPeriod.endDate}" pattern="d.M.yyyy"/>
                    </td>
                </tr>
                </tbody>
            </table>
    ...
    <div class="layout-container">
        ...
        <div class="col-2">
            <h2><fmt:message key="partridge.application.population.justification"/></h2>

            <ul>
                <li>
                    <c:out value="${model.justification}"/>
                </li>
            </ul>

            <hr>

            <h2><fmt:message key="partridge.application.population.transferredAnimalOrigin"/></h2>

            <ul>
                <li>
                    <c:out value="${model.transferredAnimalOrigin}"/>
                </li>
            </ul>

            <hr>

            <h2><fmt:message key="partridge.application.population.transferredAnimalAmount"/></h2>

            <ul>
                <li>
                    <c:out value="${model.transferredAnimalAmount}"/>
                </li>
            </ul>

            <hr>

            <h2><fmt:message key="partridge.application.population.populationAmount"/></h2>

            <ul>
                <li>
                    <c:out value="${model.populationDescription}"/>
                </li>
            </ul>
        </div>
    </div>
