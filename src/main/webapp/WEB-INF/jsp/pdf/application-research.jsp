...
<div id="main-container">
    ...
    <div class="layout-container">
        <div class="col-1">
            <fmt:message key="research.application.heading.reasons"/>
        </div>
        ...
        <div class="col-2">
            <c:forEach var="lawSection" items="${model.reasons.reasons}" varStatus="ls">
                ...
                <c:if test="${lawSection.lawSection == 'SECTION_41A'}">
                    ...
                    <hr>
                    <ul>
                        <li><fmt:message key="derogation.application.reason.REASON_RESEARCH_41A"></fmt:message></li>
                    </ul>
                </c:if>
                <c:if test="${lawSection.lawSection == 'SECTION_41B'}">
                    ...
                    <hr>
                    <ul>
                        <li><fmt:message key="derogation.application.reason.REASON_RESEARCH"></fmt:message></li>
                    </ul>
                </c:if>
                <c:if test="${lawSection.lawSection == 'SECTION_41C'}">
                    ...
                    <hr>
                    <ul>
                        <li><fmt:message key="derogation.application.reason.REASON_RESEARCH_41C"></fmt:message></li>
                    </ul>
                </c:if>
                <hr>
                <br/>
    ...
    <div class="layout-container">
        <div class="col-1">
            <fmt:message key="research.application.heading.justification"/>
        </div>
        <div class="col-2">
