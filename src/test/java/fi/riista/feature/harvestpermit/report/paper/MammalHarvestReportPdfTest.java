...
public class MammalHarvestReportPdfTest {
    ...
    private static PermitHarvestReportPdf createDummyPdf() throws IOException {
        ...
        application.setHarvestPermitCategory(HarvestPermitCategory.MAMMAL);
        ...
        final Map<Integer, LocalisedString> speciesNameIndex = Collections
                .singletonMap(41423, new LocalisedString("VILLISIKA", "VILDSVIN"));
    ...
    public static void main(final String[] args) {
        try {
            ...
            final File tempFile = File.createTempFile("mammal-harvest-report", ".pdf");
