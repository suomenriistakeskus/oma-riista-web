...
public class HarvestRegistryDerogationMapperTest implements DefaultEntitySupplierProvider {
    ...
    public void setup() {
        ...
        derogation = model.newHarvestPermit(DocumentNumberUtil.createDocumentNumber(2019, 3, 1984));
    ...
    public void testExcessAmountsAreMapped() {
        SPECIES_WITH_GENDER_FIELD.forEach(code -> {
            ...
            final List<HarvestRegistryItem> items = HarvestRegistryDerogationMapper.transform(
                            harvest,
                            shooter,
    ...
    private void transform() {
        final List<HarvestRegistryItem> itemList = HarvestRegistryDerogationMapper.transform(
                harvest,
                shooter,
