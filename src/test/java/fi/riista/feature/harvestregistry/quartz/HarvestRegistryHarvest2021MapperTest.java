...
public class HarvestRegistryHarvest2021MapperTest implements DefaultEntitySupplierProvider {
    ...
    public void testDoesNotTransformOtherSpecies() {
        ...
        final List<HarvestRegistryItem> itemList = HarvestRegistryHarvest2021Mapper.INSTANCE.transform(
                harvest,
                shooter,
    ...
    public void testHarvestsWithCommonAndMunicipalityFields() {
        ...
        verifyCommonAndMunicipalityAttributes(OFFICIAL_CODE_GREYLAG_GOOSE);
    }
    ...
    public void testHarvestsWithCommonPlusGenderAndGeolocationFields() {
        ...
        verifyCommonPlusTimeGenderAndGeolocationAttributes(OFFICIAL_CODE_GREY_SEAL);
    }
    ...
    private void testExcessAmounts(final int speciesCode, final boolean shouldHaveGenderInfo) {
        ...
        final List<HarvestRegistryItem> items = HarvestRegistryHarvest2021Mapper.INSTANCE.transform(
                harvest,
                shooter,
    ...
    private void createHarvest(final int officialCode) {
        ...
        harvest.setPointOfTime(new LocalDate(2021, 8, 20)
