...
public class MoosePermitStatisticsFeatureTest extends EmbeddedDatabaseTest {
            ...
            withHuntingGroupFixture(rhy, species, f1 -> withHuntingGroupFixture(rhy, species, f2 -> {
                ...
                onSavedAndAuthenticated(createNewModerator(), () -> {
                    ...
                    final List<MoosePermitStatisticsDTO> stats = feature.calculateByHolder(
                            rhy.getId(), Locales.FI, speciesCode, huntingYear, OrgType.RHY, rhy.getOfficialCode());
    ...
    public void testCalculate_onlyHarvests() {
        withMooseHuntingGroupFixture(fixture -> {
            ...
            final List<MoosePermitStatisticsDTO> stats = feature.calculateByHolder(
                    fixture.rhy.getId(), Locales.FI, fixture.species.getOfficialCode(), fixture.speciesAmount.resolveHuntingYear(), OrgType.RHY, fixture.rhy.getOfficialCode());
