...
public interface RhyAnnualStatisticsTestDataPopulator extends ValueGeneratorMixin {
    ...
    default void populateAllWithMatchingSubsidyTotalQuantities(@Nonnull final RhyAnnualStatistics statistics,
        ...
        hunterTraining.setMooselikeHuntingLeaderTrainingParticipants(10);
        ...
        hunterTraining.setCarnivoreHuntingLeaderTrainingParticipants(10);
        hunterTraining.setMooselikeHuntingTrainingParticipants(10);
        ...
        hunterTraining.setCarnivoreHuntingTrainingParticipants(10);
        hunterTraining.setSrvaTrainingEvents(hunterTrainingEvents);
        hunterTraining.setSrvaTrainingParticipants(10);
        ...
        hunterTraining.setCarnivoreContactPersonTrainingParticipants(10);
        hunterTraining.setAccidentPreventionTrainingEvents(hunterTrainingEvents);
        hunterTraining.setAccidentPreventionTrainingParticipants(10);

        final YouthTrainingStatistics youthTraining = statistics.getOrCreateYouthTraining();
        youthTraining.setSchoolTrainingEvents(studentAndYouthTrainingEvents);
        youthTraining.setNonSubsidizableSchoolTrainingEvents(mapNullable(studentAndYouthTrainingEvents, i->i*2));
        youthTraining.setSchoolTrainingParticipants(10);
        ...
        youthTraining.setCollegeTrainingParticipants(10);
        ...
        youthTraining.setOtherYouthTargetedTrainingParticipants(10);
        ...
        jhtTraining.setGameDamageTrainingParticipants(10);
        ...
        jhtTraining.setHunterExamOfficialTrainingParticipants(10);
        ...
        jhtTraining.setHuntingControlTrainingParticipants(10);
        ...
        jhtTraining.setShootingTestTrainingParticipants(10);
        ...
        otherHunterTraining.setSmallCarnivoreHuntingTrainingParticipants(10);
        ...
        otherHunterTraining.setGameCountingTrainingParticipants(10);
        ...
        otherHunterTraining.setGamePopulationManagementTrainingParticipants(10);
        ...
        otherHunterTraining.setGameEnvironmentalCareTrainingParticipants(10);
        ...
        otherHunterTraining.setOtherGamekeepingTrainingParticipants(10);
        ...
        otherHunterTraining.setShootingTrainingParticipants(10);
        ...
        otherHunterTraining.setTrackerTrainingParticipants(10);
