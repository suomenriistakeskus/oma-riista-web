package fi.riista.feature.permit.application.deportation.applicant;
...
public class DeportationApplicantFeatureTest extends EmbeddedDatabaseTest {

    @Resource
    private DeportationApplicantFeature feature;
