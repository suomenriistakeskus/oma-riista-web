...
public class DisabilityPermitApplicationApplicantFeatureTest extends EmbeddedDatabaseTest {

    @Resource
    private DisabilityPermitApplicationApplicantFeature feature;
    ...
    public void setup() {
        ...
        application = model().newHarvestPermitApplication(rhy, null, HarvestPermitCategory.DISABILITY);
    ...
    public void testGetPermitHolderInfo() {
        onSavedAndAuthenticated(createNewUser("applicant", applicant), () -> {
            ...
            assertThat(permitHolderInfo, is(notNullValue()));
    ...
    public void testUpdatePermitHolder() {
        onSavedAndAuthenticated(createNewUser("applicant", applicant), () -> {
            ...
            runInTransaction(() -> {
                ...
                assertThat(permitHolder.getName(), is(equalTo(dto.getName())));
                assertThat(permitHolder.getCode(), is(equalTo(dto.getCode())));
