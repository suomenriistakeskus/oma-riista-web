package fi.riista.feature.permit.application.lawsectionten.applicant;
...
public class LawSectionTenPermitApplicationApplicantFeatureTest extends EmbeddedDatabaseTest {

    @Resource
    private LawSectionTenPermitApplicationApplicantFeature feature;
