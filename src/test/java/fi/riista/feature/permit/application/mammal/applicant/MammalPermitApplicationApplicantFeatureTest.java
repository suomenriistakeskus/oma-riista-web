package fi.riista.feature.permit.application.mammal.applicant;
...
public class MammalPermitApplicationApplicantFeatureTest extends EmbeddedDatabaseTest {

    @Resource
    private MammalPermitApplicationApplicantFeature feature;
