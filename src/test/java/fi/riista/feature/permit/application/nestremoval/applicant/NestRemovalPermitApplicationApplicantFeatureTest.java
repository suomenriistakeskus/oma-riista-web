package fi.riista.feature.permit.application.nestremoval.applicant;
...
public class NestRemovalPermitApplicationApplicantFeatureTest extends EmbeddedDatabaseTest {

    @Resource
    private NestRemovalPermitApplicationApplicantFeature feature;
