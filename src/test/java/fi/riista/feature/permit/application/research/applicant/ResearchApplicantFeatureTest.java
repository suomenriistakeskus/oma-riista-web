package fi.riista.feature.permit.application.research.applicant;
...
public class ResearchApplicantFeatureTest extends EmbeddedDatabaseTest {

    @Resource
    private ResearchApplicantFeature feature;
