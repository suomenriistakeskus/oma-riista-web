...
public class LupahallintaImportMailHandlerTest extends EmbeddedDatabaseTest {
    ...
    public void testCollectRkaOfficialCodes() {
        assertEquals(Sets.newHashSet("200", "500"), LupahallintaImportMailHandler.collectRkaOfficialCodes(Arrays.asList(
