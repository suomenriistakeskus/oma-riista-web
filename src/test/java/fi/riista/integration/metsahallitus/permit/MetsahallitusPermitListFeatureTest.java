...
public class MetsahallitusPermitListFeatureTest extends EmbeddedDatabaseTest {
    ...
    @Test
    public void testFindsBySsn_status160() {
        final Person person = model().newPerson();
        ...
        mhPermit.setStatus(MetsahallitusPermitImportDTO.PAID_1);
        ...
        onSavedAndAuthenticated(createNewModerator(), () -> {
            ...
            assertThat(dto.getPermitIdentifier(), equalTo(mhPermit.getPermitIdentifier()));
        });
    }

    @Test
    public void testFindsBySsn_status162() {
        final Person person = model().newPerson();
        person.setHunterNumber(null);
        final MetsahallitusPermit mhPermit = model().newMetsahallitusPermit("Karhulupa", "Karhualue", null);
        mhPermit.setSsn(person.getSsn());
        mhPermit.setStatus(MetsahallitusPermitImportDTO.PAID_2);
