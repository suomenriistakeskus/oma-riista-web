...
public class MetsastajaRekisteriFinnishPersonValidatorTest {

    private final MetsastajaRekisteriFinnishPersonValidator validator = new MetsastajaRekisteriFinnishPersonValidator();
    ...
    public void testInvalidSsnBecauseOfTooOldPerson() {
        person.setSsn("260900-707U");
        validate();
    }
    ...
    public void testInvalidHuntingCardRange_StartAfterEnd() {
        final LocalDate tmp = person.getHuntingCardEnd();
