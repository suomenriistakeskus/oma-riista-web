...
public class AuthorizationTokenCollectorTest {
    ...
    public static class TestContext {
        ...
        TestContext(SystemUser.Role role, EntityPermission permission) {
            this.authentication = TestAuthenticationTokenUtil.createAuthentication(role, 1L);
    ...
    public void testShouldEvaluateSuppliers() {
        final TestContext testContext = new TestContext();
        testContext.helper.grant(EntityPermission.READ, TestAuthorisationRole.FIRST);
        testContext.collector.addAuthorizationRole(TestAuthorisationRole.FIRST, () -> true);
